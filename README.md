...
Ebben a listában hivatalos (adventista egyház által jóváhagyott) és nemhivatalos források egyaránt szerepelnek. E listának az a célja, hogy forrásokat biztosítson egyéni kutatások elősegítésére. Itt nincs olyan, hogy jó forrás, csak forrás van, mert e listának az a célja, hogy az ember minél több forrásból tudjon meríteni, tájékozódni, és nem az, hogy egy bizonyos elképzelést, tanítást alátámasztó források legyenek felsorolva. Ezért lehetnek egymásnak ellentmondó források, de ez nem baj, mert a cél a sokszínűség, mert vannak különböző álláspontok és nézetek, és a kutató egyéni feladata és felelőssége kikutatni az igazságot. Tehát ez a lista nem elkötelezett egyetlen adventista irányzat tanítása iránt sem (ha még kezdetben úgy is tűnik), hanem ellenkezőleg, kívánja minél több irányzat tanítását megismertetni a kutató emberrel, hogy így az embernek kiszélesítse a látókörét, hogy jobban át tudjon látni dolgokat, hogy akár az egyes források (rész) igazságaiból egy összetett igazságot tudjon felfedezni a tanulmányozó egyén.
...
- [Light channel Transylvania](http://ltvhu.org/) - David Gates videók, reggeli áhítat, videók, hanganyagok
